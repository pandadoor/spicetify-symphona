...
- [View Playlists With Song](https://github.com/illocean/spicetify-melior) - another Spicetify extension by the same author for discovering every playlist that contains a selected song.
